...
/* ==================================================================================== *\
 * BELOW ARE SOME OF UNDERSCORE.JS' TESTS WHICH WE'RE IN THE PROCESS OF REPLICATING
\* ==================================================================================== */
...
function do_not_run ()
{
  ...
  test('collections: reduce', function()
  {
    ...
    {
      return a + b
    }), 30, 'initially-sparse arrays with no memo');
  });
